...
export const productRepository = {
    ...
    createProduct: async (data: CreateProductRequest): Promise<ActionResult<Product>> => {
        const result = await tryCatch(axiosPrivate.post<Product>("/products", data));
    ...
    updateProduct: async (id: string, data: UpdateProductRequest): Promise<ActionResult<Product>> => {
        const result = await tryCatch(axiosPrivate.put<Product>(`/products/${id}`, data));
